  ...
  return (
    <section id="about" className=" py-24 px-4 relative">
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <h3 className="text-2xl font-semibold">
              Passionate Web Developer & Design 
            </h3>
        ...
        {/* Floating Alert */}
        {showAlert && (
          <div className="fixed bottom-5 right-5 bg-red-800 text-white px-4 py-2 rounded-lg shadow-lg animate-fade-in z-50">
            🚧 Coming soon! CV not available.
          </div>
        )}
      </div>
    </section>
