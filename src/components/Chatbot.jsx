    ...
    const handleSendMessage = async () => {
        ...
        lowerInput.includes("pemilik situs") ||
        lowerInput.includes("dibuat") ||
        lowerInput.includes("pembuat website") ||
        lowerInput.includes("siapa yang membuat") ||
        lowerInput.includes("siapa pemilik situs ini?")
        ) {
        botResponse = "Website ini dibuat oleh Galuh Saputra, seorang web developer yang suka dengan React, Tailwind, dan Figma!";
        } 
        else if (
        ["galuh sekolah dimana?", "sekolah mana"].some(str => lowerInput.includes(str)) ||
        lowerInput.includes("sekolah galuh") ||
        lowerInput.includes("sekolah dimana")
        ) {
        botResponse = "Galuh bersekolah di SMK Brantas Karangkates, jurusan Rekayasa Perangkat Lunak (RPL)";
        } 

        else if (
        ["galuh lahir kapan?", "lahir", "ulang tahun", "kapan galuh lahir"].some(str => lowerInput.includes(str)) ||
        lowerInput.includes("tanggal lahir galuh") 
        ) {
        botResponse = "12 Desember 2007 adalah tanggal lahir Galuh. Ia lahir di Blitar, Jawa Timur!";
        } 
        ...
        botResponse = "Galuh adalah seorang pelajar yang suka membuat website menarik dan desain thumbnail ala heroisgod. Ia juga senang belajar tentang ilmu yang berhubungan dengan teknologi!";
        } else {
